...
const communityQueueHelp = 'Community PRs outside Needs attention shows recently active external-contributor PRs that are reviewer-actionable, separately from the core-team Needs attention queue. Like Needs attention, it excludes PRs blocked on the author (failing CI, merge conflicts, unresolved feedback, held labels, or changes requested), and PRs with no activity in the last 14 days move to the Aged out community bucket on the signal board. The All community PRs bucket on the signal board lists every open community PR.';
  ...
  return (
    <section className="queue-overview" aria-label="Queue overview">
      ...
      <section className="focus-panel" aria-label="Community pull request queue">
        <div className="attention-card-header">
          <div className="attention-card-title">
            <span>Community PRs outside Needs attention</span>
