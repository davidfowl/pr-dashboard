...
const communityQueueHelp = 'Community PRs shows recently active external-contributor PRs that are reviewer-actionable, separately from the core-team Needs attention queue. Like Needs attention, it excludes PRs blocked on the author (failing CI, merge conflicts, unresolved feedback, held labels, or changes requested), and PRs with no activity in the last 14 days move to the Aged out community bucket on the signal board. The All community PRs bucket on the signal board lists every open community PR.';
